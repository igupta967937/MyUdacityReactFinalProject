...
const About = () => {
    ...
    const developer = [
        { name: 'GitHub', url: 'https://github.com/igupta967937' },
        { name: 'LinkedIn', url: 'https://www.linkedin.com/in/ishaan-gupta-940b31101/' }
    ];
    ...
    return (
        <article className="about">
            ...
            <div className="col col-right">
                ...
                <p>You can fork or see the code in <a href="https://github.com/igupta967937" target="_blank" rel="noopener noreferrer">
                https://github.com/igupta967937</a></p>

                <h2>Developer</h2>

                <p>I am Orignally From India But i live in Poland . I am a Full Stack Web Developer with
